...
public class MainRegistry {
	...
	public static ArmorMaterial enumArmorMaterialAntiSchrabbidium = EnumHelper.addArmorMaterial(RefStrings.MODID + ":ANTI_SCHRABIDIUM", RefStrings.MODID + ":ANTI_SCHRABIDIUM", Integer.MAX_VALUE, new int[] { 3, 8, 6, 3 }, 100, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0F);
